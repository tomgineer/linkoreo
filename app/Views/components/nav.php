<nav class="navbar bg-base-300 z-999">
    ...
    <div class="flex items-center gap-2">
        ...
        <?php if (logged_in()): ?>
            <a class="btn hidden lg:inline-flex lg:px-4 btn-outline border-base-content/30 hover:btn-error hover:border-error"
        ...
        <?php else: ?>
            <a class="btn hidden lg:inline-flex lg:px-4 btn-outline border-base-content/30 hover:btn-success hover:border-success" href="<?= site_url('sign-in') ?>">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5">
